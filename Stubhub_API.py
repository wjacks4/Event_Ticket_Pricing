				...
				try:
					...
					for event in event_list:
						...
						if 'PARKING' not in event_name:
							...
							event_key = (event_name + event_venue + event_city + event_state + str(event_date_UTC) + str(current_date))
							# print(event_key)
							...
							event_array = pd.DataFrame([[artist, '', event_name, event_id, event_venue, event_city, event_state, event_date_UTC, lowest_price, highest_price, ticket_count, listing_count, current_date]],
														columns=['artist', 'artist_id', 'name', 'ID', 'venue', 'city', 'state', 'date_UTC', 'lowest_price', 'highest_price', 'ticket_count', 'listing_count', 'create_ts'])
